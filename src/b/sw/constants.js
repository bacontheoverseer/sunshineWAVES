...
const SHELL_CACHE = "sunshine-shell-" + CACHE_VERSION;
const RUNTIME_CACHE = "sunshine-runtime-" + CACHE_VERSION;
const PREFETCH_CACHE = "sunshine-prefetch-nav-" + CACHE_VERSION;
const LARGE_CACHE = "sunshine-large-files-" + CACHE_VERSION;
...
const PREFETCH_HEADER = "x-sunshine-prefetch";
