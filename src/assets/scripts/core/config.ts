...
export const DEFAULT_BOOKMARKS: Bookmark[] = [
  ...
  { name: "movies", url: "https://dulo.tv", icon: "fa-solid fa-film" },
  { name: "music", url: "https://lossless.wtf/", icon: "fa-solid fa-music" },
...
export type SearchEngineUrl = (typeof SEARCH_ENGINES)[SearchEngineKey];
...
export type BangKey = keyof typeof BANGS;